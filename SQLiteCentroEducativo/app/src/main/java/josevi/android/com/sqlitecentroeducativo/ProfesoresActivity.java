...
public class ProfesoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cajaDespacho = (EditText) findViewById(R.id.cajaNota);
        ...
        botonInsertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                values.put(EstructuraBBDD.CURSO_PROFESOR, Integer.valueOf(cajaCurso.getText().toString()));
        ...
        botonBorrarXId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isNumber(cajaId.getText().toString()) == false){
                    ...
                    if(CheckIsDataAlreadyInDBorNot(EstructuraBBDD.TABLE_PROFESORES, "_id", cajaId.getText().toString())==true) {
        ...
        botonConsultas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentConsultas = new Intent(ProfesoresActivity.this, ConsultasActivity.class);
